...
/** \file
    ...
    \author Timo Suoranta (tksuoran@gmail.com) conversion from C to C#
*/
...
namespace RenderStack.Math
{
    ...
    public class SimplexNoise
    {
        ...
        const float a = 0.81649658f;

        static readonly float[,] grad3u = {
         ...
         */
        static void gradrot2(int hash, float sin_t, float cos_t, out float gx, out float gy)
        {
            int h = hash & 7;
            float gx0 = grad2[h,0];
            float gy0 = grad2[h,1];
        ...
        static void gradrot3(int hash, float sin_t, float cos_t, out float gx, out float gy, out float gz)
        {
            int h = hash & 15;
        ...
        */
        float srdnoise2(float x, float y, float angle, out float dnoise_dx, out float dnoise_dy)
        {
            ...
            sin_t = (float)System.Math.Sin( angle );
            cos_t = (float)System.Math.Cos( angle );
            ...
            * c = (3-sqrt(3))/6   */
            ...
            {
                gradrot2( perm[ii + perm[jj]], sin_t, cos_t, out gx0, out gy0 );
                t20 = t0 * t0;
                t40 = t20 * t20;
            ...
            {
                gradrot2( perm[ii + i1 + perm[jj + j1]], sin_t, cos_t, out gx1, out gy1 );
                t21 = t1 * t1;
                t41 = t21 * t21;
            ...
            {
                gradrot2( perm[ii + 1 + perm[jj + 1]], sin_t, cos_t, out gx2, out gy2 );
                t22 = t2 * t2;
                t42 = t22 * t22;
        ...
        float srdnoise3(
            ...
            float angle,
            out float dnoise_dx, out float dnoise_dy, out float dnoise_dz
        )
        {
            ...
            * c = 1/6.   */
            ...
            {
                gradrot3(perm[ii + perm[jj + perm[kk]]], sin_t, cos_t, out gx0, out gy0, out gz0);
                t20 = t0 * t0;
                t40 = t20 * t20;
            ...
            {
                gradrot3(perm[ii + i1 + perm[jj + j1 + perm[kk + k1]]], sin_t, cos_t, out gx1, out gy1, out gz1);
                t21 = t1 * t1;
                t41 = t21 * t21;
            ...
            {
                gradrot3(perm[ii + i2 + perm[jj + j2 + perm[kk + k2]]], sin_t, cos_t, out gx2, out gy2, out gz2);
                t22 = t2 * t2;
                t42 = t22 * t22;
            ...
            {
                gradrot3( perm[ii + 1 + perm[jj + 1 + perm[kk + 1]]], sin_t, cos_t, out gx3, out gy3, out gz3 );
                t23 = t3 * t3;
                t43 = t23 * t23;
